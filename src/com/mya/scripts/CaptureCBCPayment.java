...
public class CaptureCBCPayment extends DriverTestCase
{	
	@Test
	...
	{			
		...
		try
		{
			...
			cbchelpers.ClickItem("BillingInfo.PayByCC");
			
			//fill in Card Number
			cbchelpers.FillinData("CheckOut.CardNumber", "4111111111111111");
			
			//fill in Expiration month
			cbchelpers.ExpirationMonth("04-April");
			
			//fill in Expiration Year
			cbchelpers.ExpirationYear("2022");
			
			//fill in card security code
			cbchelpers.FillinData("CheckOut.CardSecurityCode", "4355");
