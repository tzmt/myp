...
public class SubmitACBTApplicationForIndividual extends DriverTestCase
{	
	@Test
	...
	{			
		...
		try
		{
			...
			getWebDriver().navigate().to(ACBT_app_url_Indvaccnt);
			
			//Select Country
			acbthelper.CountryOfRes("India");
		   ...
		   //Select location where born
			...
			acbthelper.FillinData("BillingInfo.BillingPhone", "5676546766");
			
			//Fill in Billing Street
			acbthelper.FillinData("BillingInfo.BillingStreet", "Test");
			
			//Fill in Billing city 
			acbthelper.FillinData("BillingInfo.BillingCity", "Noida");
			
			//Fill in postal code
			acbthelper.FillinData("BillingInfo.Postalcode", "201301");
			
			//Select privacy policy check box
			cbchelpers.ClickItem("BillingInfo.PrivacyPolicy");
			
			//Pay by other options
			acbthelper.ClickItem("BillingInfo.PayByOther");
