...
public class SubmitCBCApplicationAsComplementry extends DriverTestCase
{	
	@Test
	public void testCBCApplicationAsComplementry() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			System.out.println("Testing Application URL:");
			getWebDriver().navigate().to(CBC_app_url_CMP);
