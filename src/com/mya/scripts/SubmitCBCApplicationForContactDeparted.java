...
public class SubmitCBCApplicationForContactDeparted extends DriverTestCase
{	
	@Test
	public void testCBCApplicationForContactDeparted() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			System.out.println("Testing Application URL:");
			getWebDriver().navigate().to(CBC_app_url_DepartedC);
		    ...
		    //sfdchelper.VerifyProductOveride("BC DEP CONTACT");
			
			//Verify Payment Method
			sfdchelper.VerifyPaymenAmount("$400.00");
			sfdchelper.waitForWorkAroundTime(2000);
			System.out.println("Payment is set to $400");
