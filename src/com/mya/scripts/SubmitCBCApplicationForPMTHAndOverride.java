...
public class SubmitCBCApplicationForPMTHAndOverride extends DriverTestCase
{	
	@Test
	public void testCBCApplicationForPMTHAndOverride() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			System.out.println("Testing Application URL:");
			getWebDriver().navigate().to(CBC_app_url_PMTHAndOverride);
			...
			sfdchelper.clickOn("//*[@id='CF00NV00000016nQ9_ileinner']/a");
			sfdchelper.waitForWorkAroundTime(3000);
