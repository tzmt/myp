...
public class SubmitCBCApplicationFromJapan extends DriverTestCase
{	
	@Test
	...
	{			
		...
		try
		{
			...
			//Select Country
			cbchelpers.SelectCountryOfStay("Japan");
			
			//Select Member Status
			cbchelpers.SelectListItem("YoPersInfo.JMemberStatus","Japanese Member" );
