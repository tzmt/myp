...
public class SubmitCBCApplicationFromUS extends DriverTestCase
{	
	@Test
	public void testCBCApplicationFromUS() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			//Select Country
			cbchelpers.SelectCountryOfStay("United States");
			
			//Select State
			cbchelpers.SelectListItem("YoPersInfo.USState", "Arizona" );
