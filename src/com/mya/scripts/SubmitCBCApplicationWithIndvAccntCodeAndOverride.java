...
public class SubmitCBCApplicationWithIndvAccntCodeAndOverride extends DriverTestCase
{	
	@Test
	public void testCBCApplicationWithIndvAccntCodeAndOverride() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(CBC_app_url_Indvaccntoverride);
