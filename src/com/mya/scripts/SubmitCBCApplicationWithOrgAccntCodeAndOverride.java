...
public class SubmitCBCApplicationWithOrgAccntCodeAndOverride extends DriverTestCase
{	
	@Test
	public void testCBCApplicationWithOrgAccntCodeAndOverride() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(CBC_app_url_Orgaccntoverride);
