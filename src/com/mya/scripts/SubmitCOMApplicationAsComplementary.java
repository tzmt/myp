...
public class SubmitCOMApplicationAsComplementary extends DriverTestCase
{	
	@Test
	public void testCOMApplicationAsComplementary() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(COM_app_url_CMP);
