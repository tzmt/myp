...
public class SubmitCOMApplicationForOrgWithCode extends DriverTestCase
{	
	@Test
	public void testCOMApplicationForOrgWithCode() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(COM_app_url_Orgaccnt);
