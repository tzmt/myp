...
public class SubmitCOMApplicationForOverride extends DriverTestCase
{	
	@Test
	public void testCOMApplicationForOverride() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(COM_app_url_Override);
