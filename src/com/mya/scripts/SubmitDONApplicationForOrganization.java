...
public class SubmitDONApplicationForOrganization extends DriverTestCase
{	
	@Test
	public void testDONApplicationForOrganization() throws Exception
	{			
		//Initialize objects
		...
		String orgname = "Aman Donation Org " +getRandomInteger(1, 999);
		...
		try
		{
			...
			getWebDriver().navigate().to(DON_app_url);
			
			//Select Applicant type
			donhelper.SelectApplicant("Organization");
			...
			donhelper.FillinData("OrgInfo.OrgName", orgname);
			...
			sfdchelper.clickOn("link="+orgname);
