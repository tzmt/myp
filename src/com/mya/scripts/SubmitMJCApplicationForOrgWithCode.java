...
public class SubmitMJCApplicationForOrgWithCode extends DriverTestCase
{	
	@Test
	public void testMJCApplicationForOrgOrgWithCode() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(MJC_app_url_Orgaccnt);
