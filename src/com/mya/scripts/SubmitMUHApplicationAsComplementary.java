...
public class SubmitMUHApplicationAsComplementary extends DriverTestCase
{	
	@Test
	public void testMUHApplicationAsComplementary() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(MUH_app_url_CMP);
