...
public class SubmitMUHApplicationAsOverride extends DriverTestCase
{	
	@Test
	public void testMUHApplicationAsOverride() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(MUH_app_url_Override);
