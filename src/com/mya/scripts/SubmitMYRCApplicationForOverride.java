...
public class SubmitMYRCApplicationForOverride extends DriverTestCase
{	
	@Test
	public void testMYRCApplication() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(MYRC_app_url_Override);
