...
public class SubmitMYRDApplicationForOverride extends DriverTestCase
{	
	@Test
	public void testMYRDApplicationForOverride() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(MYRD_app_url_Override);
