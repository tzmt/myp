...
public class SubmitMYRDApplicationForPMTH extends DriverTestCase
{	
	@Test
	public void testMYRDApplicationForPMTH() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(MYRD_app_url_PMTH);
