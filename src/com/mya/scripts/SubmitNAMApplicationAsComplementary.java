...
public class SubmitNAMApplicationAsComplementary extends DriverTestCase
{	
	@Test
	public void testNAMApplicationAsComplementary() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(NAM_app_url_CMP);
