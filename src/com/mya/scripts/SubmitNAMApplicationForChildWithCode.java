...
public class SubmitNAMApplicationForChildWithCode extends DriverTestCase
{	
	@Test
	public void testNAMApplicationForChildWithCode() throws Exception
	{			
		//Initialize objects
		...
		try
		{
			...
			getWebDriver().navigate().to(NAM_app_url_Childaccnt);
